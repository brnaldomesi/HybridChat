                    ...
                    AccessToken.getCurrentAccessToken().then((data) => {
                        ...
                        firebase.auth().signInWithCredential(facebookCredential)
                            .then(success => {
                                ...
                                this.props.navigation.navigate('UserInfo', { social: true, name: success.additionalUserInfo.profile.first_name + ' ' + success.additionalUserInfo.profile.last_name, pic: success.additionalUserInfo.profile.picture.data.url });
                            });
                    })
                }
            }
